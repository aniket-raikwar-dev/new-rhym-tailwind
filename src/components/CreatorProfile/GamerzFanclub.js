  ...
  return (
    <div className="mx-8 lg:mx-36 mt-32">
       ...
       <div className="mt-12 w-full flex flex-col items-center bg-zinc-800 rounded-2xl">
          ...
          {seeMore ? 
              <div className="w-full lg:w-4/5 lg:-mt-4 flex flex-wrap justify-evenly sm:justify-around">
              ...
              {array.slice(5, array.length).map((arr => (
                <div key={array} className="w-12 h-12 lg:w-36 lg:h-36 mt-4 lg:mt-12 rounded-full border-2 border-pink-600 bg-gray-500">
                  <img src={FanClubImg} alt="fanClubImg" />
                </div>
              )))}
              </div>  
